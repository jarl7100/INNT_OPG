        ...
        <>
          <View style={Style.profileContainer}>
            <ImageBackground
              ...
              source={{
                uri: "https://www.un.org/sites/un2.un.org/files/field/image/2022/06/silas-baisch-oczvgbqcjky-unsplash.jpg",
              }}
            />
            <Image
              style={Style.profileImage}
              source={{
                uri: "https://cdn.denisonyachtsales.com/wp-content/uploads/2022/08/Denison-Team-Member-Website-Profile-Headshot-210-Tom-Robertson.png",
              }}
            />
          ...
          <View style={Style.profileContainer}>
            <Card>
              ...
              <Text style={Style.profileInfo}>Email: {profile.email}</Text>
              <Text style={Style.profileInfo}>Phone: {profile.phone}</Text>
